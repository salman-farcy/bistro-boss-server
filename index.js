...
const mg = mailgun.client({
     username: 'api',
     key: process.env.MAIL_GUN_API_KEYK,
});
...
async function run() {
     try {
          ...
          app.post('/payments', async (req, res) => {
               ...
               // send usser email about payment confirmation
               mg.messages
                    .create(process.env.MAIL_SENDING_DOMAIN, {
                         from: "Mailgun Sandbox <postmaster@sandbox5e6195f9c0c34cbc893b1797f0c82927.mailgun.org>",
                         to: ["salmanfarcy253@gmail.com"],
          ...
          app.get('/order-stats', verifToken, verifyAdmin, async (req, res) => {
               const result = await paymentCollection.aggregate([
                    {
                         $unwind: '$menuItemIds'
                    },
